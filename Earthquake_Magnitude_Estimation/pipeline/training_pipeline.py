...
from Earthquake_Magnitude_Estimation.constant.training_pipeline import TRAINING_BUCKET_NAME
from Earthquake_Magnitude_Estimation.constant.training_pipeline import SAVED_MODEL_DIR
import sys
